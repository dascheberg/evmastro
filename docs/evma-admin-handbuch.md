...
> **Hinweis:** Bei falschem Passwort erscheint eine Fehlermeldung. Nach zu vielen Fehlversuchen kann der Account gesperrt werden — in diesem Fall bitte den Administrator (Dieter) kontaktieren.
...
3. Spalten zuordnen (Mapping-Maske)
4. Duplikate prüfen und behandeln
5. Nicht erkannte Werte (Veranstalter, Orte etc.) zuordnen oder neu anlegen
6. Import bestätigen
